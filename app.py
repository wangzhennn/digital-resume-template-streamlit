...
- ✔️ Individual emotional/attitudinal/behavioral outcome from application of technologies in Human Resource Management, e.g., computerized performance monitoring system
"""
)
